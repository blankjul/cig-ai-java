...
public class OriginalTest {
	public static void main(String[] args) {
		...
		String NIController = "emergence_NI.Agent";
		// Available games:
		String gamesPath = "examples/gridphysics/";
		// CIG 2014 Training Set Games
		String games[] = new String[] { "aliens", "boulderdash", "butterflies",
				"chase", "frogs", "missilecommand", "portals", "sokoban",
				"survivezombies", "zelda",
		// CIG 2014 Validation Set Games
//		 String games[] = new String[]{
				"camelRace", "digdug", "firestorms",
		 "infection", "firecaster",
		...
		//ArcadeMachine.runOneGame(game, level1, visuals, sampleOLMCTSController,
		//		recordActionsFile, seed);
		// 3. This replays a game from an action file previously recorded
		// String readActionsFile = "actionsFile_aliens_lvl0.txt"; //This
		// example is for
		...
		// sampleRandomController, null, seed);
		...
		for (int i = 0; i < N; ++i) {
			...
			for (int j = 0; j < L; ++j) {
				...
				if (saveActions)
					for (int k = 0; k < M; ++k)
						actionFiles[actionIdx++] = "actions_game_" + i
								+ "_level_" + j + "_" + k + ".txt";
			}
			ArcadeMachine.runGames(game, levels, M, NIController,
					saveActions ? actionFiles : null, seed);
		}*/
	}
}