...
/**
 * User: ssamot
 * VGDL - https://github.com/schaul/py-vgdl
 */
public class SimpleStateHeuristic extends AHeuristic {
	...
	public double evaluateState(StateObservation stateObs) {
		...
		ArrayList<Observation>[] npcPositionsNotSorted = stateObs
				.getNPCPositions();
		...
		if (portalPositions == null) {
			...
			if (npcCounter == 0) {
				...
				score = -minDistance / 100.0 + (-npcCounter) * 100.0
						+ stateObs.getGameScore() + won * 100000000;
			}
		...
		if (minObjectPortal == null) {
			...
			score = stateObs.getGameScore() + won * 1000000 - minDistancePortal
					* 10.0;
		}
