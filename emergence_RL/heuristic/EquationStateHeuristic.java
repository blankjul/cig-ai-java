...
public class EquationStateHeuristic extends AHeuristic{
	...
	public static ArrayList<AHeuristic> create(Tree tree) {
		...
		//pool.add(new EquationStateHeuristic("aliens/butterflies/missilecommand", new double[] {64.84119238866205,-6.706116268770671,15.972320970002045,-86.00116924839656,1.5311167186565768,83.48853622908294,0.5650190254932141,-83.55457187644191,96.1475129439522,51.51009302853271 }));
