...
The heuristic based algorithm has several parameter that changes the behaviour of the agent (cf. figure~\ref{fig:heur}).
...
The boxplot (cf. figure~\ref{fig:eval_heur}) visualizes the quartiles. The best parameter setup has also the largest
