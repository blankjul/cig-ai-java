...
/**
 * To start a game played by the user
 * 
 * @author spakken
 *
 */
public class OneAgentOneGameKeyboard {
	...
	/**
	 * Executes a game which will be played by a human using the keyboard
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		String testDir = String.format("%s/examples/tests/",
				System.getProperty("user.dir"));
		Game toPlay = LevelLoader.loadByPath(testDir + "scenario1.txt", testDir
				+ "s1_nextToScore.txt");
