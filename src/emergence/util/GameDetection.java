...
public class GameDetection {
	...
	public GameDetection() {
		...
		map.put(1283352747, new SortedPair<String,Integer>("missilecommand",0));
		map.put(-2028543506, new SortedPair<String,Integer>("missilecommand",1));
		map.put(2093918484, new SortedPair<String,Integer>("missilecommand",2));
		map.put(1258832973, new SortedPair<String,Integer>("missilecommand",3));
		map.put(-1079185408, new SortedPair<String,Integer>("missilecommand",4));
		...
		map.put(-324836995, new SortedPair<String,Integer>("survivezombies",0));
		map.put(-823239386, new SortedPair<String,Integer>("survivezombies",1));
		map.put(-1057797247, new SortedPair<String,Integer>("survivezombies",2));
		map.put(1901522168, new SortedPair<String,Integer>("survivezombies",3));
